...
def plot_sigma_units(h5file,show=False):
    ...
    info, info_nf, fit_param_mean_NR, fit_param_spl_NR, scat_fit_mean_NR, scat_fit_spl_NR, scat_nf_mean_NR, scat_nf_spl_NR = ut.get_data(h5file, 6.9, -0.92, True)
    ...
    info, info_nf, fit_param_mean_R, fit_param_spl_R, scat_fit_mean_R, scat_fit_spl_R, scat_nf_mean_R, scat_nf_spl_R = ut.get_data(h5file, 7.05, -0.867, True)
