...
def plot_E_CM_L_multi_non_res(h5file,beta,m0,levels=False,outname=None,show=False):
    info, info_nf, fit_param_mean, fit_param_spl, scat_fit_mean, scat_fit_spl, scat_nf_mean, scat_nf_spl = ut.get_data(h5file, beta, m0, False)
...
def plot_E_CM_L_multi_705(h5file,levels=False,outname=None,show=False):
    ...
    info, info_nf, fit_param_mean, fit_param_spl, scat_fit_mean, scat_fit_spl, scat_nf_mean, scat_nf_spl = ut.get_data(h5file, 7.05, 0.863, False)
    ...
    info, info_nf, fit_param_mean, fit_param_spl, scat_fit_mean, scat_fit_spl, scat_nf_mean, scat_nf_spl = ut.get_data(h5file, 7.05, 0.867, False)
