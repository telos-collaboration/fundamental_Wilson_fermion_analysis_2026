...
def plot_PS_ERE_non_res(h5file,show=False):
    ...
    ax1.yaxis.grid()
    ax2.yaxis.grid()
    info, info_nf, fit_param_mean, fit_param_spl, scat_fit_mean, scat_fit_spl, scat_nf_mean, scat_nf_spl = ut.get_data(h5file, 6.9, -0.92, True)
...
def plot_PS_ERE_res(h5file,show=False):
    ...
    ax1.yaxis.grid()
    ax2.yaxis.grid()
    info, info_nf, fit_param_mean, fit_param_spl, scat_fit_mean, scat_fit_spl, scat_nf_mean, scat_nf_spl = ut.get_data(h5file, 7.05, -0.867, True)
