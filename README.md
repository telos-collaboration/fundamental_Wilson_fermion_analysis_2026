...
trivial for someone not already familiar with the code.## Setup
...
3. Download the archive containing the raw log files named `raw_data.tar` from [the Zenodo data release][datarelease] and untar it in this directory.
