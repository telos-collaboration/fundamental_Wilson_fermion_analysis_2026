...
run(`julia src/scripts_julia/plot_correlation_matrix.jl --h5file_in $(h5file_com) --plotpath $(plotpath)`)
run(`julia src/scripts_julia/plot_eigenvalues.jl --h5file_in $(h5file_eig) --plotpath $(plotpath) --three_by_three $use3x3`)
run(`julia src/scripts_julia/plot_effective_masses.jl --h5file_eig $(h5file_eig) --h5file_fit $(h5file_fit) --plotpath $(plotpath) --infinite_volume $infvolfile --three_by_three $use3x3`)
