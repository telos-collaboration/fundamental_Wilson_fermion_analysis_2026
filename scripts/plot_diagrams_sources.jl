...
CorrD_4  = h5dset["E1/p(0,0,1)/d/p_diag(0,0,1)/C_re"][]
Corrπ_4  = h5dset["E1/p(0,0,1)/pi/p_diag(0,0,1)/C_re"][]
Corrρ_4  = h5dset["E1/p(0,0,1)/rho_g33/p_diag(0,0,1)/C_re"][]
CorrT1_4 = -h5dset["E1/p(0,0,1)/t1_g3/p_diag(0,0,1)/C_im"][]
CorrT2_4 =  h5dset["E1/p(0,0,1)/t2_g3/p_diag(0,0,1)/C_im"][]

CorrR1_4 = h5dset["E1/p(0,0,1)/r1/p_diag(0,0,1)/C_re"][]
CorrR2_4 = h5dset["E1/p(0,0,1)/r2/p_diag(0,0,1)/C_re"][]
CorrR3_4 = h5dset["E1/p(0,0,1)/r3/p_diag(0,0,1)/C_re"][]
CorrR4_4 = h5dset["E1/p(0,0,1)/r4/p_diag(0,0,1)/C_re"][]
...
CorrD_16  = h5dset["E1/p(0,0,1)/d/p_diag(0,0,1)/C_re"][]
Corrπ_16  = h5dset["E1/p(0,0,1)/pi/p_diag(0,0,1)/C_re"][]
Corrρ_16  = h5dset["E1/p(0,0,1)/rho_g33/p_diag(0,0,1)/C_re"][]
CorrT1_16 = -h5dset["E1/p(0,0,1)/t1_g3/p_diag(0,0,1)/C_im"][]
CorrT2_16 =  h5dset["E1/p(0,0,1)/t2_g3/p_diag(0,0,1)/C_im"][]
CorrR1_16 = h5dset["E1/p(0,0,1)/r1/p_diag(0,0,1)/C_re"][]
CorrR2_16 = h5dset["E1/p(0,0,1)/r2/p_diag(0,0,1)/C_re"][]
CorrR3_16 = h5dset["E1/p(0,0,1)/r3/p_diag(0,0,1)/C_re"][]
CorrR4_16 = h5dset["E1/p(0,0,1)/r4/p_diag(0,0,1)/C_re"][]
