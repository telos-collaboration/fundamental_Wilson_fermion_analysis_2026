...
function write_p001_correlation_matrix(file_in,file_out)
    ...
    @showprogress desc="Write correlation matrices" for ens in ensembles
        ...
        if "p(0,0,2)" ∈ p_external
            Corrπ, Corrρ, CorrT1, CorrT2, CorrR1, CorrR2, CorrR3, CorrR4, CorrD1, CorrD2, CorrD1_old = correlatorsp001(fid,ens;p=2)
            Corr2π = pipi_correlator(CorrD1,CorrD2,CorrR1,CorrR2,CorrR3,CorrR4,L)
            Corr   = pipi_rho_matrix(Corr2π,Corrρ,CorrT1,CorrT2,L)
        ...
        if "p(1,1,0)" ∈ p_external
            Corrπ, Corrρ, CorrT1, CorrT2, CorrR1, CorrR2, CorrR3, CorrR4, CorrD1, CorrD2, CorrD1_old = correlatorsp110(fid,ens;p=1)
            Corr2π = pipi_correlator(CorrD1,CorrD2,CorrR1,CorrR2,CorrR3,CorrR4,L)
            Corr   = pipi_rho_matrix(Corr2π,Corrρ,CorrT1,CorrT2,L)
        ...
        if "p(1,1,0)" ∈ p_external
            Corrπ, Corrρ, CorrT1, CorrT2, CorrR1, CorrR2, CorrR3, CorrR4, CorrD1, CorrD2, CorrD1_old = correlatorsp110_alt(fid,ens;p=1)
            Corr2π = pipi_correlator(CorrD1,CorrD2,CorrR1,CorrR2,CorrR3,CorrR4,L)
            Corr   = pipi_rho_matrix(Corr2π,Corrρ,CorrT1,CorrT2,L)
            
            h5write(file_out,joinpath(ens,"p(1,1,0)_alt","correlation_matrix"),Corr)
            h5write(file_out,joinpath(ens,"p(1,1,0)_alt","correlator_pion"),Corrπ)
        end
    end
end
