...
m2π, Δm2π   = implicit_meff(Corr2π';sign)
m1π, Δm1π   = implicit_meff(Corr1π')
m1ρ, Δm1ρ   = implicit_meff(Corr1ρ')
m1π0, Δm1π0 = implicit_meff(Corr1π0')
m1ρ0, Δm1ρ0 = implicit_meff(Corr1ρ0')
