...
function plot_meff_from_gevp!(plot2x2,h5dset,ens,p,t0,deriv;use3x3=true,gevp=true,half_sources=false,average_equivalent_momenta,symmetrise)
...
function plot_effective_masses(corr_file, fitresults, infvolfile, plotpath, fitparam; t0, deriv, gevp, average_equivalent_momenta, symmetrise, use3x3=true, half_sources=true)
