...
CorrR3 = h5dset["E1/p(0,0,1)/r3/p_diag(0,0,1)/C_re"][]
CorrR4 = h5dset["E1/p(0,0,1)/r4/p_diag(0,0,1)/C_re"][]
...
pltMes  = plot()
pltCross = plot()
scatter!(pltMes,Cπ, yerr=ΔCπ,yscale=:log10, label="(π)")
scatter!(pltMes,Cρ, yerr=ΔCρ,yscale=:log10, label="(ρ)")

scatter!(pltCross,CT1,yerr=ΔCT1,yscale=:log10,label="(-Im(T1))")
scatter!(pltCross,CT2,yerr=ΔCT2,yscale=:log10,label="(+Im(T2))")

scatter!(pltPiPi,CD, yerr=ΔCD,yscale=:log10,label="(D)")
scatter!(pltPiPi,CR1,yerr=ΔCR1,yscale=:log10,label="(R1)")
scatter!(pltPiPi,CR2,yerr=ΔCR2,yscale=:log10,label="(R2)")
scatter!(pltPiPi,CR3,yerr=ΔCR3,yscale=:log10,label="(R3)")
scatter!(pltPiPi,CR4,yerr=ΔCR4,yscale=:log10,label="(R4)")
