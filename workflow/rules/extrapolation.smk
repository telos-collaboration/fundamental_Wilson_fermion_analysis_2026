...
rule Mass_continuum_massless_extrapolation:
    ...
    input:
        ...
        script="spectrum/src/extrapolation_mass.py",
    output:
...
rule Mass_continuum_massless_ansatz_extrapolation:
    ...
    input:
        ...
        script="spectrum/src/extrapolation_ansatze.py",
    output:
...
rule Decay_continuum_massless_ansatz_extrapolation:
    ...
    input:
        ...
        script="spectrum/src/extrapolation_ansatze_decay.py",
    output:
...
rule Decay_continuum_massless_extrapolation:
    ...
    input:
        ...
        script="spectrum/src/extrapolation_decay.py",
    output:
